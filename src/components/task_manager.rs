// Create src/components/task_manager.rs
...
pub fn TaskManager(task_controller: TaskController) -> impl IntoView {
    ...
    let create_task = {
        ...
        move |_| {
            ...
            task_controller.create_task(new_task);
    ...
    let create_subtask = {
        ...
        move |task_id: String| {
            ...
            task_controller.create_subtask(new_subtask);
                            ...
                            view! {
                                <div class="space-y-4">
                                    {progress_summary.into_iter().map(|(task, completion_percentage, completed_subtasks, total_subtasks)| {
                                        ...
                                        let task_controller_item = task_controller.clone();
                                        ...
                                        view! {
                                            <div class="border rounded-lg bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 p-4">
                                                    ...
                                                    <div class="flex space-x-2">
                                                        ...
                                                        <button
                                                            ...
                                                            on:click={
                                                                ...
                                                                let task_controller_toggle = task_controller_item.clone();
                                                        ...
                                                        <button
                                                            ...
                                                            on:click={
                                                                ...
                                                                let task_controller_delete = task_controller_item.clone();
                                                                move |_| {
                                                                    if web_sys::window()
                                                ...
                                                // New Subtask Form
                                                {
                                                    let task_id_form = task_id.clone();
                                                    let create_subtask_clone = create_subtask.clone();
                                                    move || {
                                                        if show_new_subtask_form.get() == Some(task_id_form.clone()) {
                                                            view! {
                                                                    ...
                                                                    <div class="space-y-2">
                                                                        ...
                                                                        <div class="flex space-x-2">
                                                                            <button
                                                                                ...
                                                                                on:click={
                                                                                    let task_id_create = task_id_form.clone();
                                                                                    let create_subtask_fn = create_subtask_clone.clone();
                                                                                    move |_| create_subtask_fn(task_id_create.clone())
                                                                                }
                                                ...
                                                // Subtasks List
                                                {
                                                    let task_id_subtasks = task_id.clone();
                                                    let task_controller_subtasks = task_controller_item.clone();
                                                    move || {
                                                        let subtasks = task_controller_subtasks.get_subtasks_for_task(&task_id_subtasks);
                                                        if !subtasks.is_empty() {
                                                            view! {
                                                                <div class="mt-3 space-y-2">
                                                                    {subtasks.into_iter().map(|subtask| {
                                                                        let subtask_id = subtask.id.clone();
                                                                        let subtask_controller = task_controller_subtasks.clone();
                                                                                ...
                                                                                <div class="flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-400">
                                                                                    ...
                                                                                    <button
                                                                                        ...
                                                                                        on:click={
                                                                                            ...
                                                                                            let subtask_controller_toggle = subtask_controller.clone();
                                                                                    ...
                                                                                    <button
                                                                                        ...
                                                                                        on:click={
                                                                                            ...
                                                                                            let subtask_controller_delete = subtask_controller.clone();
                                                                                            move |_| {
                                                                                                if web_sys::window()
